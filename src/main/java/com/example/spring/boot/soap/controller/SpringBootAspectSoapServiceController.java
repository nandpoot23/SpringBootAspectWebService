...
@Component
@Endpoint("SpringBootAspectSoapServiceController")
public class SpringBootAspectSoapServiceController {

    private static final String NAMESPACE_URI = "http://dm.xml.soap.sample.com/";

    private static final Logger logger = LoggerFactory.getLogger(SpringBootAspectSoapServiceController.class);
    ...
    public QueryEmpConfigsResponse queryEmpConfigs(@RequestPayload QueryEmpConfigs queryCustomer,
        ...
        com.example.spring.boot.rest.types.EmpDetails restImplResponse = dmService
                .queryEmpConfigs(SpringBootAspectSoapServiceRequestMapper.mapQueryEmpConfigsSoapRequest(queryCustomer));

        if (logger.isDebugEnabled())
            logger.debug("Returning Response for queryEmpConfigs");

        return SpringBootAspectSoapServiceResponseMapper.mapQueryEmpConfigsSoapResponse(restImplResponse);
    }
    ...
    public SelectAllEmpAllDataResponse selectAllEmpAllData(@RequestPayload SelectAllEmpAllData selectAllEmpAllData,
        ...
        List<EmpDetails> restImplResponse = dmService.selectAllEmpAllData(SpringBootAspectSoapServiceRequestMapper
                .mapSelectAllEmpAllDataSoapRequest(selectAllEmpAllData));

        if (logger.isDebugEnabled())
            logger.debug("Returning Response for selectAllEmpAllData");

        return SpringBootAspectSoapServiceResponseMapper.mapSelectAllEmpAllDataSoapResponse(restImplResponse);
