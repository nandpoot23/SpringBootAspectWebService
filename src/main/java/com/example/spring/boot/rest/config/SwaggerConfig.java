...
public class SwaggerConfig extends WebMvcConfigurerAdapter {
    ...
    public Docket restfulApi() {
        return new Docket(DocumentationType.SWAGGER_2).groupName("aspect-dm-service").select()
    ...
    private ApiInfo apiInfo() {
        ApiInfo apiInfo = new ApiInfo("Aspect Demand Service",
                "Aspect Demand Service identifies and manages employee, maintains emp-level data, "
                        + "and track their relationships to other entities (e.g. email , mobile) ", "1.0",
                "Aspect Demand API terms of service", new Contact("", "", ""), "", "");
        return apiInfo;
    }
